...
const apiSampleGet = createGetApi(apiLayer, memoizedGet, 'mock is never called so this is ignored');
...
const apiSampleSet = createSetApi(apiLayer, setApi, 'mock is never called so this is ignored', [apiSampleGet]);
